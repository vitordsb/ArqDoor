    ...
    <section className="bg-[#F05B10] pb-0 pt-14 text-white md:pt-20">
      <div className="mx-auto w-full max-w-[1360px] px-4">
        <div className="mx-auto max-w-[980px] text-center">
          <p className="mx-auto max-w-[920px] text-sm font-medium leading-relaxed text-[#ffe8da] sm:text-base md:text-lg">
          ...
          <div className="mt-8 md:mt-10">
            <Button
              asChild
              className={`h-[54px] rounded-full bg-[#f1f1f1] px-8 text-[#cf5315] hover:bg-white md:h-[62px] md:px-14 ${landingType.buttonText}`}
            >
